...
struct SectionView: View {
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(spacing: 15) {
                    SectionTileView(sectionTitle: "Introduction to Monet", sectionCategory: "Lesson 1", sectionImage: "classicism", isUnlocked: true, userProgress: 0.7)
                    SectionTileView(sectionTitle: "Monet's Famous Works", sectionCategory: "Lesson 2", sectionImage: "stJohnTheBaptist", isUnlocked: false, userProgress: 0.0);
